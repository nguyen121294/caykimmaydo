        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-slate-50">
              <tr>
                <th className="text-left px-4 py-3.5 font-semibold text-slate-700">Khách hàng</th>
                <th className="text-left px-4 py-3.5 font-semibold text-slate-700">Liên hệ</th>
                <th className="text-left px-4 py-3.5 font-semibold text-slate-700">Nguồn</th>
                <th className="text-left px-4 py-3.5 font-semibold text-slate-700">Điểm</th>
                <th className="text-left px-4 py-3.5 font-semibold text-slate-700">Hạng</th>
                <th className="text-left px-4 py-3.5 font-semibold text-slate-700">Chi tiêu</th>
                <th className="text-left px-4 py-3.5 font-semibold text-slate-700">Mua gần nhất</th>
