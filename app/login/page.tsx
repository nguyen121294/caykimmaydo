      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <button
            ...
            className="w-full py-2.5 rounded-lg border border-gray-200 bg-white text-gray-700 font-medium text-sm hover:bg-gray-50 transition disabled:opacity-50 flex items-center justify-center gap-3 mb-5"
          >
            {googleLoading ? (
          ...
          <div className="relative mb-5">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white px-3 text-gray-400">hoặc đăng nhập bằng email</span></div>
          </div>
