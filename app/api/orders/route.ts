  ...
  try {
    ...
    const order = await prisma.$transaction(async tx => {
      ...
      const data: Prisma.OrderUpdateInput = {
        ...
        ...(body.productType !== undefined ? { productType: optionalText(body.productType) } : {}),
        ...(body.quantity !== undefined ? { quantity: Math.max(1, Math.round(numberValue(body.quantity, 1))) } : {}),
        ...(body.fabricType !== undefined ? { fabricType: optionalText(body.fabricType) } : {}),
        ...(body.status !== undefined ? { status: String(body.status) } : {}),
        ...(body.tailorName !== undefined ? { tailorName: optionalText(body.tailorName) } : {}),
        ...(body.orderDate !== undefined ? { orderDate: optionalText(body.orderDate) } : {}),
        ...(body.tryDate !== undefined ? { tryDate: optionalText(body.tryDate) } : {}),
        ...(body.deliveryDate !== undefined ? { deliveryDate: optionalText(body.deliveryDate) } : {}),
        ...(body.expectedDate !== undefined ? { expectedDate: optionalText(body.expectedDate), deliveryDate: optionalText(body.expectedDate) } : {}),
        ...(body.deliveryAddress !== undefined ? { deliveryAddress: optionalText(body.deliveryAddress) } : {}),
        ...(body.department !== undefined ? { department: optionalText(body.department) } : {}),
        ...(body.fabricCost !== undefined ? { fabricCost: numberValue(body.fabricCost) } : {}),
        ...(body.tailorCost !== undefined ? { tailorCost: numberValue(body.tailorCost) } : {}),
        ...(body.shippingFee !== undefined ? { shippingFee: numberValue(body.shippingFee) } : {}),
        ...(body.paymentMethod !== undefined ? { paymentMethod: optionalText(body.paymentMethod) } : {}),
        ...(body.paymentAccount !== undefined ? { paymentAccount: optionalText(body.paymentAccount) } : {}),
        ...(body.notes !== undefined ? { notes: optionalText(body.notes) } : body.note !== undefined ? { notes: optionalText(body.note) } : {}),
        ...(body.deposit !== undefined ? { deposit: numberValue(body.deposit) } : {}),
        ...(body.total !== undefined ? { total: numberValue(body.total), price: String(body.total), listPrice: numberValue(body.listPrice, numberValue(body.total)) } : {}),
